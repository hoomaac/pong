    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        public void ResetBinding(InputAction action, int bindingIndex)
        {
            ...
            foreach (InputAction otherAction in action.actionMap.actions)
            {
                ...
                for (int i = 1; i < otherAction.bindings.Count; i++)
                {
            ...
            m_RebindOperation = action.PerformInteractiveRebinding(bindingIndex)
                ...
                .OnComplete(
                    operation =>
                    {
                        ...
                        if (CheckDuplicateKeys(action, bindingIndex, allCompositeParts))
                        {
                            action.RemoveBindingOverride(bindingIndex);
                            CleanUp();
        ...
        private bool CheckDuplicateKeys(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            InputBinding newBinding = action.bindings[bindingIndex];
